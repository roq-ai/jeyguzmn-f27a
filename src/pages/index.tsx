...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`jeyguzmn`}</title>

        <meta
          name="description"
          content="Experience seamless management with jeyguzmn - Your ultimate solution for tourist apartments. Connect, publish, and keep track of reservations effortlessly across multiple platforms like Airbnb and Booking."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1616523815683-ed5cada3e3d1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0b3VyaXN0JTIwYXBhcnRtZW50c3xlbnwwfHx8fDE2OTQzNjQzMTZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@nadine3?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Nadine Marfurt`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless management with jeyguzmn - Your ultimate solution for tourist apartments. Connect, publish, and keep track of reservations effortlessly across multiple platforms like Airbnb and Booking.`}
            </Text>
            <Box
